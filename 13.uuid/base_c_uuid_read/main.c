...
int main()
{
    ...
    *(unsigned short *)REG_ADDR(riu_base->virt_addr, 0x20, 0x03) &= ~BIT8;
    ...
    f_data.worid[0] = *(unsigned short *)REG_ADDR(riu_base->virt_addr, 0x20, 0x16);
    f_data.worid[1] = *(unsigned short *)REG_ADDR(riu_base->virt_addr, 0x20, 0x17);
    f_data.worid[2] = *(unsigned short *)REG_ADDR(riu_base->virt_addr, 0x20, 0x18);
